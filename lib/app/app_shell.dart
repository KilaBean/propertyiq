...
const _managerTabs = [
  _Tab(AppRoutes.dashboard, Icons.grid_view_outlined, Icons.grid_view_rounded,
      'Home'),
  _Tab(AppRoutes.properties, Icons.apartment_outlined, Icons.apartment,
      'Properties'),
...
const _tenantTabs = [
  ...
  _Tab(AppRoutes.tenantPayments, Icons.account_balance_wallet_outlined,
      Icons.account_balance_wallet, 'Pay'),
  _Tab(AppRoutes.tenantMaintenance, Icons.build_outlined, Icons.build,
      'Requests'),
  _Tab(AppRoutes.profile, Icons.person_outline, Icons.person, 'Profile'),
];
